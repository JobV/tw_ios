 ...
 * rest2mobile plugin because LocationSpec.m already exists. You
 * can merge the code below into LocationSpec.m manually.
 */
...
describe(@"Location", ^{
    ...
    context(@"when calling getLocation", ^{
        ...
        it(@"should invoke", ^{
            ...
            __block LocationResult *_response;
            [sut getLocation:userID
                        body:body
                     success:^(LocationResult *response){
                        _response = response;
                     }
